  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      const res = await apiFetch(
        `/api/v1/organizations/${organization.id}/profile`,
        {
          method: "PUT",
    ...
    >
      <div className="mb-6">
        <p className="text-gray-600">
          Manage your organization's account, billing, and team settings.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        {/* Team Management */}
        <Card>
          <h3 className="font-semibold text-gray-800 mb-4">Team Management</h3>
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 border rounded">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Hiring Manager • sarah@company.com
                </p>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Receive updates about team activity and billing
                </p>
              </div>
