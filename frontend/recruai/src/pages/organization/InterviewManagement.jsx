...
const BulkDeleteModal = ({ isOpen, onClose, onConfirm, saving, count }) => {
  const handleConfirm = () => {
    onConfirm();
  };
    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <div className="mb-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-red-800">
                Are you sure you want to delete {count} interview
                {count !== 1 ? "s" : ""}?
              </h3>
              <div className="mt-2 text-sm text-red-700">
                <p>
                  This action cannot be undone. All selected interviews will be
                  permanently deleted.
                </p>
              </div>
            </div>
      ...
      <div className="flex gap-3 justify-end">
        ...
        >
          {saving
            ? "Deleting..."
            : `Delete ${count} Interview${count !== 1 ? "s" : ""}`}
        </button>
      </div>
    </Modal>
  );
