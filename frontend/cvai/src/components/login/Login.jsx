...
export default function Login() {
  ...
  // Show message if redirected due to token expiration
  useEffect(() => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Ensure user has a plan (default to free if not specified)
      const userData = { ...data.user, plan: data.user.plan || "free" };
        ...
        <div className="flex">
          ...
          <div className="w-1/2 bg-gradient-to-br from-primary-600 to-accent-700 p-12 flex flex-col justify-center items-center text-white">
            ...
            <p className="text-lg text-primary-100 text-center">
              Sign in to your account and continue your journey with cvAI
            </p>
          </div>
