...
export default function Profile() {
    ...
    const loadProfileData = async () => {
      try {
        ...
        const [
          ...
          fetch(`${API_BASE}/profile/sections`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/experiences`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/educations`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/skills`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/projects`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/publications`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/awards`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/certifications`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/languages`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/volunteer-experiences`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/references`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/hobby-interests`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/professional-memberships`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/patents`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/course-trainings`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/social-media-links`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/key-achievements`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/conferences`, { credentials: "include" }),
          fetch(`${API_BASE}/profile/speaking-engagements`, {
            credentials: "include",
          }),
          fetch(`${API_BASE}/profile/licenses`, { credentials: "include" }),
        ]);
  ...
  const confirmDelete = async () => {
    ...
    try {
      let endpoint = "";
      if (type === "experiences")
        endpoint = `${API_BASE}/profile/experiences/${item.id}`;
      else if (type === "educations")
        endpoint = `${API_BASE}/profile/educations/${item.id}`;
      else if (type === "skills")
        endpoint = `${API_BASE}/profile/skills/${item.id}`;
      else if (type === "projects")
        endpoint = `${API_BASE}/profile/projects/${item.id}`;
      else if (type === "publications")
        endpoint = `${API_BASE}/profile/publications/${item.id}`;
      else if (type === "awards")
        endpoint = `${API_BASE}/profile/awards/${item.id}`;
      else if (type === "certifications")
        endpoint = `${API_BASE}/profile/certifications/${item.id}`;
      else if (type === "languages")
        endpoint = `${API_BASE}/profile/languages/${item.id}`;
      else if (type === "volunteerExperiences")
        endpoint = `${API_BASE}/profile/volunteer-experiences/${item.id}`;
      else if (type === "references")
        endpoint = `${API_BASE}/profile/references/${item.id}`;
      else if (type === "hobbyInterests")
        endpoint = `${API_BASE}/profile/hobby-interests/${item.id}`;
      else if (type === "professionalMemberships")
        endpoint = `${API_BASE}/profile/professional-memberships/${item.id}`;
      else if (type === "patents")
        endpoint = `${API_BASE}/profile/patents/${item.id}`;
      else if (type === "courseTrainings")
        endpoint = `${API_BASE}/profile/course-trainings/${item.id}`;
      else if (type === "socialMediaLinks")
        endpoint = `${API_BASE}/profile/social-media-links/${item.id}`;
      else if (type === "keyAchievements")
        endpoint = `${API_BASE}/profile/key-achievements/${item.id}`;
      else if (type === "conferences")
        endpoint = `${API_BASE}/profile/conferences/${item.id}`;
      else if (type === "speakingEngagements")
        endpoint = `${API_BASE}/profile/speaking-engagements/${item.id}`;
      else if (type === "licenses")
        endpoint = `${API_BASE}/profile/licenses/${item.id}`;
  ...
  const saveItem = async (itemData) => {
    ...
    try {
      ...
      let endpoint = `${API_BASE}/profile/${type}`;
  ...
  const handleProfilePictureUpload = async (event) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE}/profile/upload-profile-picture`,
        {
          method: "POST",
          credentials: "include",
          body: formData,
