...
from src.models import Experience, Project
import json
from datetime import datetime

# Experience endpoints
@profile_bp.route('/experiences', methods=['GET'])
@jwt_required()
def get_experiences():
...
@profile_bp.route('/experiences/<int:exp_id>', methods=['PUT'])
@jwt_required()
...
@profile_bp.route('/experiences/<int:exp_id>', methods=['DELETE'])
@jwt_required()
