...
from app.models import User, Experience, Education, Skill, Project, Publication, ProfileSection, Award, Certification, Language, VolunteerExperience, Reference, HobbyInterest, ProfessionalMembership, Patent, CourseTraining, SocialMediaLink, KeyAchievement, Conference, SpeakingEngagement, License, TeamMember
import os
...
def upload_profile_picture():
    ...
    uploads_root = os.path.join(current_app.root_path, 'uploads', 'profile_pictures')
