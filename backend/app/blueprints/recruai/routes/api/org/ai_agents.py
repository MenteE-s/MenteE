...
from app.models import AIInterviewAgent, Organization, Interview
...
def test_ai_agent(agent_id):
    ...
    try:
        # Import AI service
        from app.services.recruai.ai_service import get_ai_service
...
def test_ai_service():
    ...
    from app.services.recruai.ai_service import test_ai_connection
