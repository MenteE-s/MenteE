...
from app.models import Education, Skill, Language
from datetime import datetime

# Education endpoints
@profile_bp.route('/educations', methods=['GET'])
@jwt_required()
def get_educations():
...
@profile_bp.route('/educations', methods=['POST'])
@jwt_required()
...
@profile_bp.route('/educations/<int:edu_id>', methods=['PUT'])
@jwt_required()
...
@profile_bp.route('/educations/<int:edu_id>', methods=['DELETE'])
@jwt_required()
...
# Languages endpoints
@profile_bp.route('/languages', methods=['GET'])
@jwt_required()
def get_languages():
...
@profile_bp.route('/languages/<int:lang_id>', methods=['PUT'])
@jwt_required()
...
@profile_bp.route('/languages/<int:lang_id>', methods=['DELETE'])
@jwt_required()
